...
public class TestFileManager {
	  ...
	  public void upload() throws Exception {
	    File content = new File("d:\\demo.log"); 
	    ...
	    FastDFSFile file = new FastDFSFile("demo", file_buff, "log");
	  ...
	  public void getFile() throws Exception {
	    FileInfo file = FileManager.getFile("group1", "M00/00/00/wKi7glee-QWASaYsAAAAJfQmW1A782.txt");
	    Assert.notNull(file);
	  ...
	  public void getFetchStorages() throws Exception {
	    ServerInfo[] servers = FileManager.getFetchStorages("group1", "M00/00/00/wKi7glee-QWASaYsAAAAJfQmW1A782.txt");
